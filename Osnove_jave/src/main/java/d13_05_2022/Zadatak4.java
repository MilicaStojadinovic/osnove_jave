...
// program ne reaguje na takve zahteve tj. nista ne ispisuje, a ukoliko korisnik zamoli tada program ispisuje
...
// Za ovaj zadatak trebace vam nextLine metoda sa scannerom.
        ...
        //Unesite zahtev: Molim te, podseti me da kupim prasak!
        //Dogovoreno!
        ...
        while (!zahtev.equals("Hvala!")) {
            System.out.print("Unestite zahtev: ");
            zahtev = s.nextLine();
