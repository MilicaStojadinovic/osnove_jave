...
public class Task2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i <5; i++) {
            ...
            driver.findElement(By.id("department")).sendKeys("Administration");
            driver.findElement(By.id("phone")).sendKeys("(171) 555-2222");
//            driver.findElement(By.xpath("//tr[last()]/td[last()]/a")).click();
            Thread.sleep(1000);
            List<WebElement>elements = driver.findElements(By.className("add"));
